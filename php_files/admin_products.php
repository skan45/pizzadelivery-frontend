...
if(isset($_POST['add_product'])){
   ...
   $image_folder = 'c:\users\ASUS\PhpstormProjects\DevWeb\uploaded_img\\'.$image;
   ...
   if($select_product->rowCount() > 0){
      ...
      if($image_size > 2000000){
         ...
         $id=rand(1,10000);
         $insert_product->execute([$id,$name, $price, $image]);
...
if(isset($_GET['delete'])){
   ...
   unlink('c:\users\ASUS\PhpstormProjects\DevWeb\uploaded_img\\'.$fetch_delete_image['image']);
